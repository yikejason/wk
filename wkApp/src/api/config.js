...
//   prizeUrl: 'https://hdtest.ucuxin.com',//测试抽奖链接
//   shopUrl: 'http://shoptest.ucuxin.com/widget/template/index.html?id=124',//测试商城链接
//   //服务包地址
...
//   //课程列表
//   getCourseList: () => {
//     if (test_debugger) return 'htest.ucuxin.com/wkxtapp/introduce.html'
//     return 'htest.ucuxin.com/wkxtapp/introduce.html'
//   }
// };

//正式版
let Config = {
  production_api: 'https://api.ucuxin.com/',   //正式api
  development_api: 'https://api.ucuxin.com/',  //连条后api
  shareUrl: 'https://h.ucuxin.com/wkxtapp/',//url
  shareIocn: 'https://img.ucuxin.com/ux/builtin/Contact_WKXT.png',
  debugger: false, //是否是调试状态  链条前状态 true=> tao.org api
  //分享字段
  learnCourse_share_text: '微课学堂专业的学科辅导专家，提分就靠它，我正在学习，你呢',
  teachRecommend_share_text: '微课学堂专业的学科辅导专家，提分就靠它，快来学习吧',
  teachLearnCourse_share_text: '微课学堂专业的学科辅导专家，提分就靠它，快来学习吧',
  prizeUrl: 'https://hd.ucuxin.com',//抽奖正式链接
  shopUrl: 'https://shop.ucuxin.com/shop/index.html?sid=279',//商城正式链接
  //服务包地址
  servicePackage: (token) => {
    return `https://lapp.ucuxin.com/charge/choice_identity.html?token=${token}&funcid=17`
  },
  //获得token
  getH5TokenParams: () => {
    return {appid: 1019, appSecret: '885d5eec511c459a9b77112818596f07'}
  },
  // 介绍页
  getCourseList: () => {
    return 'https://h.ucuxin.com/wkxtapp/introduce.html'
  }
};
...
if (process.env.NODE_ENV === `development`) {
  ConfigEvn = {
    token: 'b475da35b35c46a5aa217d8f444a3157'
  }
}
