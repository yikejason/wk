...
export default class Home extends React.Component {
    ...
    pieData = (name, cnt, rate) => {
        ...
        return option = {
            color: ['#35A6E8','#A4D8FD',],
            title: {
                text:'{gray|' + Math.round(cnt) + '}{green|' + name + '}',
                textStyle: {
                    rich: {
                        gray: {
                            padding:[
                    ...
                    : <div className={styles.classReport}>
                        <div className={styles.card}>
                            ...
                            <div className={styles.card_content_circle}>
                                ...
                                <div>
                                    <ReactEcharts className={styles.pie}
                                                  option={this.pieData('分钟', parseInt(Math.round(LearnConditionReport.AvgLearnSeconds / 60)), 100)}
                                                  style={{height: 240, width: '100%'}}/>
                                    <div style={{textAlign:"center", color:"#c2c2c2",paddingTop: '5px'}}>平均学习时长</div>
                                </div>
                            </div>
                        ...
                        <div className={styles.card}>
                            ...
                            <div style={{marginLeft:10}}><span style={{
                                marginTop:10,
                                fontSize:24,
                                color:"#888888",
                                lineHeight:1.4,
                            }}>{!LearnTimeFrameReport ? '' : LearnTimeFrameReport.Conclusion}</span></div>
                        </div>
                        <div className={styles.card}>
                            <div className={styles.card_title}>
                                <h3>学科观看率</h3>
...

                        {
                            ...
                            ? 
                                (<div className={styles.card}>
                                    ...
                                    {
                                        ContinLearnReport && ContinLearnReport.Cnt !== 0 ?
                                            <ReactEcharts
                                                // option={this.getOption1(ContinLearnReport.ChartData.XAxials, ContinLearnReport.ChartData.YAxials, true)}
                                                option={ContinLearnReport && ContinLearnReport.ChartData 
                                                    ? this.getOption1(ContinLearnReport.ChartData.XAxials ,ContinLearnReport.ChartData.YAxials, true) 
                                                    : this.getOption1(0,0)}
                                                style={{height: '350px', width: '100%'}}
                                    ...
                                    }
                                    {
                                        ContinLearnReport && ContinLearnReport.Conclusion  ?
                                            <div style={{marginLeft:10}}><span style={{
                                                ...
                                                color:"#888888",
                                                lineHeight:1.4,
                                            }}>{!ContinLearnReport ? '' : ContinLearnReport.Conclusion}</span></div>
                                            : ""
                                    }
                                </div> )
                            : 
                                (<div className={styles.card}>
                                    ...
                                    </div>
                                    {
                                        AccumuLearnReport && AccumuLearnReport.Days !== 0 ?
                                            <ReactEcharts
                                                option={AccumuLearnReport && AccumuLearnReport.ChartData ? this.getOption1(AccumuLearnReport.ChartData.XAxials ,AccumuLearnReport.ChartData.YAxials, true) : this.getOption1(0,0)}
                                                style={{height: '350px', width: '100%'}}
