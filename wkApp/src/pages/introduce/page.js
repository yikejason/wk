...
export default class Introduce extends React.Component {
    ...
    render() {
        const {showMore,isRender, data: {BoughtCnt, BoughtList, LearnList, Pic, PicLink, DataType}} = this.state
                ...
                <div className={styles.introduce}>
                    ...
                    <div style={{backgroundColor: '#fff', borderBottom: '1px solid #e5e5e5'}}>
                        ...
                        <div style={{
                            ...
                            {BoughtList.map((type, i) => (
                                <div key={i} style={{margin: "20px 50px",padding:"0 0px", textAlign: 'center'}}>
                               
                                    <img src={type.UPic} key={i}
                                        style={{display: "block",width: '88px', borderRadius: '50%', }}
                                        alt=""/>
                                   
                                        <span style={{ margin:'auto 0', whiteSpace:"nowrap", fontSize:25, textAlign:'center',overflow:'hidden', textOverflow: 'ellipsis'}}>
                                        {type.UName}
                                        </span>
                    ...
                    <div style={{backgroundColor: '#fff', marginBottom: '120px'}}>
                        ...
                        }}>看了的同学这样评价：</p>
                        {
                            ...
                            <div
                                style={{display: 'flex', borderBottom: '1px solid #e5e5e5',  margin: '20px 20px 10px 30px'}} key={i}>
                                <div  style={{width: '20%'}}>
                                    <img src={type.UPic} key={i}
